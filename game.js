    ...
    checkBtn.addEventListener('click' ,function(){
        ...
        if(value=='1'){
            ...
            divEl.textContent="You are the most pure blessing for me, I have ever been blessed with, may be as a friend but it's true, And I mean it. ";
       para.textContent="Good Job again!!👌👌";
    }
    else if(value=='6'){
